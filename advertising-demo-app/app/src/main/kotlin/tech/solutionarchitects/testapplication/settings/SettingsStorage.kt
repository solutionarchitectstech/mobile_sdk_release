...
import tech.solutionarchitects.testapplication.Constants

object SettingsStorage {
    private lateinit var prefs: SharedPreferences
    private const val BASE_URL_STRING = "base_url_string"
    fun init(context: Context) {
        prefs = context.getSharedPreferences("settings_prefs", Context.MODE_PRIVATE)
    }

    var baseUrl: String
        get() = prefs.getString(BASE_URL_STRING, Constants.baseUrl) ?: Constants.baseUrl
        set(value) = prefs.edit().putString(BASE_URL_STRING, value).apply()
}